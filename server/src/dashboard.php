...
class dashboard implements ServiceProviderInterface
{
    ...
    private function parseHost($index, $content ){
        if( !isset( $content) || empty($content) ){
            $content = '{"id":"196.27.64.122-2017-04-16-00:53:19","analysisDate":"2017-04-15 20:53:19","host":"196.27.64.122","status":"OK","rate":"0","trend":"no","vulnerabilitiesCount":0,"requiredUpdatesCount":0,"systemInformation":{"operatingSystem":"unknown","version":"unknown"},"vulnerabilities":[],"requiredUpdate":[],"openPorts":[{"port":8080,"protocol":"TCP","status":"open","defaultUsage":"http"},{"port":22,"protocol":"TCP","status":"open","defaultUsage":"ssh"}]}';
        }
